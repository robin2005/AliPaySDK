...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   AliPay 移动支付接口智能 SDK 版 for iOS

  s.homepage     = "https://www.alipay.com/"
  ...
  # s.authors            = { "robin2005" => "57048685@qq.com" }
  ...
  s.source       = { :git => "https://github.com/robin2005/FBAliPaySDK.git", :tag => "#{s.version}" }
